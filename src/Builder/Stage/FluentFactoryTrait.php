...
trait FluentFactoryTrait
{
    ...
    public function changeStream(
        Optional|string|bool $allChangesForCluster = Optional::Undefined,
        Optional|string $fullDocument = Optional::Undefined,
        Optional|string $fullDocumentBeforeChange = Optional::Undefined,
        Optional|string|int $resumeAfter = Optional::Undefined,
        Optional|string|bool $showExpandedEvents = Optional::Undefined,
        Optional|Document|Serializable|stdClass|array|string $startAfter = Optional::Undefined,
        Optional|Timestamp|string|int $startAtOperationTime = Optional::Undefined,
    ): static {
    ...
    public function currentOp(
        Optional|string|bool $allUsers = Optional::Undefined,
        Optional|string|bool $idleConnections = Optional::Undefined,
        Optional|string|bool $idleCursors = Optional::Undefined,
        Optional|string|bool $idleSessions = Optional::Undefined,
        Optional|string|bool $localOps = Optional::Undefined,
    ): static {
     ...
     * @param Optional|Decimal128|Int64|float|int|string $distanceMultiplier The factor to multiply all distances returned by the query. For example, use the distanceMultiplier to convert radians, as returned by a spherical query, to kilometers by multiplying by the radius of the Earth.
     ...
     * @param Optional|Decimal128|Int64|float|int|string $maxDistance The maximum distance from the center point that the documents can be. MongoDB limits the results to those documents that fall within the specified distance from the center point.
     ...
     * @param Optional|Decimal128|Int64|float|int|string $minDistance The minimum distance from the center point that the documents can be. MongoDB limits the results to those documents that fall outside the specified distance from the center point.
     ...
     * @param Optional|bool|string $spherical Determines how MongoDB calculates the distance between two points:
    ...
    public function geoNear(
        ...
        Optional|Decimal128|Int64|string|int|float $distanceMultiplier = Optional::Undefined,
        Optional|string $includeLocs = Optional::Undefined,
        Optional|string $key = Optional::Undefined,
        Optional|Decimal128|Int64|string|int|float $maxDistance = Optional::Undefined,
        Optional|Decimal128|Int64|string|int|float $minDistance = Optional::Undefined,
        Optional|QueryInterface|array $query = Optional::Undefined,
        Optional|string|bool $spherical = Optional::Undefined,
    ): static {
    ...
    public function graphLookup(
        ...
        string $as,
        Optional|string|int $maxDepth = Optional::Undefined,
     ...
     * @param Optional|Document|Serializable|array|stdClass|string $let Specifies variables to use in the pipeline stages. Use the variable expressions to access the fields from the joined collection's documents that are input to the pipeline.
     ...
     */
    public function sample(string|int $size): static
    {
     ...
     * @param Optional|Document|Serializable|array|stdClass|string $highlight Specifies the highlighting options for displaying search terms in their original context.
     * @param Optional|bool|string $concurrent Parallelize search across segments on dedicated search nodes.
     ...
     * @param Optional|bool|string $scoreDetails Flag that specifies whether to retrieve a detailed breakdown of the score for the documents in the results. If omitted, defaults to false.
     * @param Optional|Document|Serializable|array|stdClass|string $sort Document that specifies the fields to sort the Atlas Search results by in ascending or descending order.
     * @param Optional|bool|string $returnStoredSource Flag that specifies whether to perform a full document lookup on the backend database or return only stored source fields directly from Atlas Search.
     * @param Optional|Document|Serializable|array|stdClass|string $tracking Document that specifies the tracking option to retrieve analytics information on the search terms.
     */
    public function search(
        Document|Serializable|SearchOperatorInterface|stdClass|array $operator,
        Optional|string $index = Optional::Undefined,
        Optional|Document|Serializable|stdClass|array|string $highlight = Optional::Undefined,
        Optional|string|bool $concurrent = Optional::Undefined,
        Optional|Document|Serializable|stdClass|array|string $count = Optional::Undefined,
        Optional|string $searchAfter = Optional::Undefined,
        Optional|string $searchBefore = Optional::Undefined,
        Optional|string|bool $scoreDetails = Optional::Undefined,
        Optional|Document|Serializable|stdClass|array|string $sort = Optional::Undefined,
        Optional|string|bool $returnStoredSource = Optional::Undefined,
        Optional|Document|Serializable|stdClass|array|string $tracking = Optional::Undefined,
    ): static {
     ...
     * @param Document|Serializable|array|stdClass|string $output Specifies the field(s) to append to the documents in the output returned by the $setWindowFields stage. Each field is set to the result returned by the window operator.
     ...
     */
    public function skip(string|int $skip): static
    {
    ...
    public function unwind(
        ...
        Optional|string|bool $preserveNullAndEmptyArrays = Optional::Undefined,
    ): static {
    ...
    public function vectorSearch(
        ...
        Optional|string|bool $exact = Optional::Undefined,
        Optional|QueryInterface|array $filter = Optional::Undefined,
        Optional|string|int $numCandidates = Optional::Undefined,
    ): static {
