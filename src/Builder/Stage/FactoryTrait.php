...
trait FactoryTrait
{
    ...
    public static function geoNear(
        ...
        Optional|Decimal128|Int64|float|int|string $distanceMultiplier = Optional::Undefined,
        ...
        Optional|bool|string $spherical = Optional::Undefined,
    ): GeoNearStage {
     ...
     */
    public static function limit(int|string $limit): LimitStage
    {
     ...
     */
    public static function sample(int|string $size): SampleStage
    {
